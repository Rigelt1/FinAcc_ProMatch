...
const RMSBroadcastPage: React.FC = () => {
  ...
  const matchLinks = [
    {
      title: '风险管理师职业技能赛项开幕式',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛开幕式直播',
      url: 'https://meeting.tencent.com/dm/7R2X1Zik5cEF',
      group:"1"
    },
    {
      title: '职工（教师）组A区',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛教师组A区比赛直播',
      url: 'https://meeting.tencent.com/dm/KVmFQ6oKUEiX',
      group:"2"
    },
    {
      title: '职工（教师）组B区',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛教师组B区比赛直播',
      url: 'https://meeting.tencent.com/dm/UYUPgi4X0jEq',
      group:"2"
    },
    {
      title: '职工（教师）组C区',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛教师组C区比赛直播',
      url: 'https://meeting.tencent.com/dm/2b9U7Bpm5DaT',
      group:"2"
    },
    {
      title: '学生组A区',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛学生组A区比赛直播',
      url: 'https://meeting.tencent.com/dm/RlQF4eOullQE',
      group:"3"
    },
    {
      title: '学生组B区',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛学生组B区比赛直播',
      url: 'https://meeting.tencent.com/dm/h153QXYgNCZr',
      group:"3"
    },
    {
      title: '学生组C区',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛学生组C区比赛直播',
      url: 'https://meeting.tencent.com/dm/63K0QLkP6gQE',
      group:"3"
    },
    {
      title: '裁判现场',
      description: '山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛裁判现场',
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      <Layout>
        ...
        <Content 
          ...
          >
          <h2 style={{ fontSize: '24px', marginBottom: '24px', color: '#1890ff' }}>山东省“技能兴鲁”职业技能大赛—风险管理师职业技能竞赛直播</h2>
          {['1', '2', '3', '4'].map((group) => {
...
export default RMSBroadcastPage;